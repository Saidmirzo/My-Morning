...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ru': {
      ...
      "subscribe_futures": "Подписка предоставит возможность выполнять такие упражнения как: Фитнес, Дневник, Чтение и Визуализация. Она продляется каждый месяц автоматически, но отменить ее можете в любое время.",
      "price": "Стоимость",
      ...
      "try_vip_desc": "Попробуйте в течение 3 дней бесплатно, а затем цена составит @price в месяц. Можете отменить в любое время",
      "vip_price_card": "1 \n месяц \n @price",
