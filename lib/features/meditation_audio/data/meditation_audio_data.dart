class MeditationAudioData {
  static Map<String, String> soundSource = {
    'Early winter':
    ...
    'Sea coast':
        'https://storage.yandexcloud.net/myaudio/Sound/Sea%20coast.mp3',
    'Troubled Ocean':
        'https://storage.yandexcloud.net/myaudio/Sound/Troubled%20Ocean.mp3',
    'Waterfall': 'https://storage.yandexcloud.net/myaudio/Sound/Waterfall.mp3',
  };

  static Map<String, String> musicSource = {
    'Bell temple':
    ...
    'Hommic': 'https://storage.yandexcloud.net/myaudio/Meditation/Hommik.mp3',
    'Meditation space':
