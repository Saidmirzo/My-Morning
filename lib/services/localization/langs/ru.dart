Map<String, String> translations_ru = {
  ...
  "faq_tarifs_desc_4":
      "<p>Восстановление работает только если у вас активна подписка. Вы можете нажать на кнопку «восстановить подписку». Или сделать это вручную <br>- Перейдите на вкладку <a href='screen:tarifs'>«тарифный план»</a> (можете нажать) <br>- Нажмите внизу восстановить <br>- Нажмите сменить тариф <br>- В следующем месяце тариф поменяется</p>",
  ...
  "faq_about_desc_5":
      "<p>Нажмите на (иконка шестеренки) в настройках <br>Выберите программу, которую хотите отредактировать <br>Нажмите редактировать <br>Есть проблемы? <a href='screen:support'>«служба поддержки»</a></p>",
  "faq_about_title_6": "Как настроить визуализации?",
  "faq_about_desc_6":
      "<p>Чтобы добавить цель нажмите на (иконка плюсика) в выборе целей <br>Затем выберите образ из тех, что сохранены в вашем телефоне <br>Подождите немного, пока картинки загрузятся <br>Вы можете воспользоваться готовыми целями и образами, или добавить свои картинки в цели по такой же инструкции <br>Есть проблемы? <a href='screen:support'>«служба поддержки»</a></p>",
};
