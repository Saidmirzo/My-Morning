Map<String, String> translations_ru = {
  ...
  "faq_about_desc_5":
      "<p>Нажмите на <img alt='settings' src='https://storage.yandexcloud.net/myaudio/Nastavnik/kartinki/02-min.png' width='25' /> в настройках <br>Выберите программу, которую хотите отредактировать <br>Нажмите редактировать <br>Есть проблемы? <a href='screen:support'>«служба поддержки»</a></p>",
  ...
  "creatures_1": "Кит",
  "creatures_2": "Водопад",
  "creatures_3": "Кошка лакает молоко",
  "creatures_4": "Лошадь галоп",
  "creatures_5": "Лошадь идет",
  "creatures_6": "Лягушка",
  "creatures_7": "Лягушки",
  "creatures_8": "Мурчание кошки",
  "creatures_9": "Птицы",
  "creatures_10": "Птицы 2",
  "creatures_11": "Сверчки",
  "creatures_12": "Сова",
  "creatures_13": "Чайка",
};
