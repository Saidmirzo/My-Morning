  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        fit: StackFit.expand,
        children: [
          SvgPicture.asset("assets/images/onboarding/onb_bg_10.svg", fit: BoxFit.cover),
          ClipRRect(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(fontSize: Platform.isIOS ? 20 : 18, color: HexColor("#592F72"), fontWeight: FontWeight.w500),
                          textAlign: TextAlign.center,
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Text(
                          "onb_11_text_3".tr,
                          style: TextStyle(fontSize: Platform.isIOS ? 20 : 18, color: HexColor("#592F72"), fontWeight: FontWeight.bold),
                          textAlign: TextAlign.center,
                        ),
                      ),
                      const Spacer(),
