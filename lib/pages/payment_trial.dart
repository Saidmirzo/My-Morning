...
class PaymentPageTrial extends StatefulWidget {
  @override
  _PaymentPageTrialState createState() => _PaymentPageTrialState();
}

class _PaymentPageTrialState extends State<PaymentPageTrial> {
  Size size;
